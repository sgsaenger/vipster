...
MillerWidget::MillerWidget(MainWindow *parent) :
    QWidget(parent),
...
//         curPlane = planes.at(&vApp.curStep());
//         auto *p = parent();
//         auto qc = qobject_cast<MainWindow*>(p);
//         auto dc = dynamic_cast<MainWindow*>(p);
//         auto sc = static_cast<MainWindow*>(p);
//         sc->curVP->addExtraData(curPlane, false);
//         // qobject_cast<MainWindow*>(parent())->curVP->addExtraData(curPlane, false);
//     }else{
//         // delete Plane
//         static_cast<MainWindow*>(parent())->curVP->delExtraData(curPlane, false);
//     }
// }
