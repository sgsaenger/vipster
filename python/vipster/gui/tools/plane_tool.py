...
class Plane(QWidget):
    ...
    def __init__(self, parent):
        ...
        def setMilPlane():
            ...
            parent.mol.setMilPlane(self.showMilPlane,
                                   [i.value() for i in self.milWidgets])
            parent.updateMol()
        ...
        def setVolPlane():
            ...
            parent.mol.setVolPlane(self.showVolPlane,
                                   self.volDir.currentIndex(),
                                   float(self.volSel.value() - 1))
            parent.updateMol()
