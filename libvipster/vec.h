...
inline Mat Mat_inv(const Mat &m)
{
    ...
    inv[0][1] = (m[1][0]*m[2][2]-m[2][0]*m[1][2])*d;
    inv[0][2] = (m[1][0]*m[2][1]-m[2][0]*m[1][1])*d;
    inv[1][0] = (m[0][1]*m[2][2]-m[2][1]*m[0][2])*d;
    inv[1][1] = (m[0][0]*m[2][2]-m[2][0]*m[0][2])*d;
    inv[1][2] = (m[0][0]*m[2][1]-m[2][0]*m[0][1])*d;
    inv[2][0] = (m[0][1]*m[1][2]-m[1][1]*m[0][2])*d;
    inv[2][1] = (m[0][0]*m[1][2]-m[1][0]*m[0][2])*d;
