...
Project {
    ...
    references: ["libvipster/libvipster.qbs", "vipster/QtVipster.qbs", "vipster/WebVipster.qbs", "python/python.qbs", "tests/tests.qbs", "dist/dist.qbs"]
    ...
    Profile {
        ...
        cpp.driverFlags: ["--bind", "-s", "ERROR_ON_UNDEFINED_SYMBOLS=1", "-s", "USE_WEBGL2=1", "-s", "WASM=1", "-s", "DISABLE_EXCEPTION_CATCHING=0", "-O3"]
