...
class MainWindow(QMainWindow):
    ...
    def initTools(self):
        ...
        for i in tools.items():
            ...
            dw.setAllowedAreas(Qt.RightDockWidgetArea|Qt.TopDockWidgetArea|Qt.BottomDockWidgetArea)
